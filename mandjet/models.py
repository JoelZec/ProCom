...
class Vehicle(models.Model):
    ...
    type = models.PositiveSmallIntegerField(_("Vehicle "), choices=VEHICLE_TYPE, default=3)
...
class TimeSlot(models.Model):
    ...
    def get_start_day(self):
        return self.start.strftime('%A')  # Format to get the day of the week

    def get_end_day(self):
        return self.end.strftime('%A')    # Format to get the day of the week
